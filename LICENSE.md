...
2. **Wyłączenie Odpowiedzialności za Dane:** Autor w najszerszym dopuszczalnym przez prawo zakresie nie ponosi odpowiedzialności za:
   ...
   b) jakiekolwiek skutki finansowe, podatkowe lub prawne wynikające z użycia danych pozyskanych przez Oprogramowanie,
   c) ewentualne zablokowanie konta Użytkownika przez operatora platformy Trading212 lub inne sankcje wynikające z naruszenia regulaminów podmiotów trzecich.
